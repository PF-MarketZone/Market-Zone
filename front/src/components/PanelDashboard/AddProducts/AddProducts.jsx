...
const validationSchema = Yup.object({
  ...
  price: Yup.number().required("Se requiere un precio")
  .test("is-not-negative", "El precio no puede ser negativo", value => value !== "-")
  .positive("El precio debe ser un número positivo"),
  stock: Yup.number()
  .required("Se requiere un número")
  .test("is-not-negative", "El stock no puede ser negativo", value => value !== "-")
